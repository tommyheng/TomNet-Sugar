...
namespace TomNet.App.Core.Services.Security
{
    ...
    /// 服务类 RoleFunctionMap
    /// </summary> 
	public partial class RoleFunctionMapService : IRoleFunctionMapContract
    {   		
		/// <summary>
        /// 服务提供者
        /// </summary>
        ...
        /// 仓储对象
        /// </summary>
		IRepository<RoleFunctionMap, int> _repository;

		/// <summary>
        /// 构造函数
        /// </summary>
        public RoleFunctionMapService(IServiceProvider provider)
        {
			_serviceProvider = provider;
			_repository = _serviceProvider.GetService<IRepository<RoleFunctionMap, int>>();
        ...
        /// 当前实体类型的查询数据集
        /// </summary>
        public ISugarQueryable<RoleFunctionMap> Entities { get; }
        ...
        /// </summary>
        /// <returns>操作影响的行数</returns>
        public int Insert(List<RoleFunctionMap> entities)
        {
            return _repository.Insert(entities);
        }

        public Task<int> InsertAsync(List<RoleFunctionMap> entities)
        {
        ...
        /// </summary>
        /// <returns>操作影响的行数</returns>
        public int Insert(RoleFunctionMap[] entities)
        {
            return _repository.Insert(entities);
        }

        public Task<int> InsertAsync(RoleFunctionMap[] entities)
        {
            return _repository.InsertAsync(entities);
        }
        ...
        /// <param name="ignoreColumns">不更新的列</param>
        /// <returns>操作影响的行数</returns>
        public int Update(List<RoleFunctionMap> entitys, string[] ignoreColumns = null)
        {
            return _repository.Update(entitys, ignoreColumns);
        }

        public Task<int> UpdateAsync(List<RoleFunctionMap> entitys, string[] ignoreColumns = null)
        {
        ...
        /// <returns>操作影响的行数</returns>
        public int Update(Expression<Func<RoleFunctionMap, RoleFunctionMap>> update, Expression<Func<RoleFunctionMap, bool>> predicate = null)
        {
            return _repository.Update(update, predicate);
        }

        public Task<int> UpdateAsync(Expression<Func<RoleFunctionMap, RoleFunctionMap>> update, Expression<Func<RoleFunctionMap, bool>> predicate = null)
        {
        ...
        /// <returns>操作影响的行数</returns>
        public int Delete(Expression<Func<RoleFunctionMap, bool>> predicate)
        {
            return _repository.Delete(predicate);
        }

        public Task<int> DeleteAsync(Expression<Func<RoleFunctionMap, bool>> predicate)
        {
        ...
        public RoleFunctionMap GetFirst(Expression<Func<RoleFunctionMap, bool>> predicate)
        {
            return _repository.GetFirst(predicate);
        }

        public Task<RoleFunctionMap> GetFirstAsync(Expression<Func<RoleFunctionMap, bool>> predicate)
        {
