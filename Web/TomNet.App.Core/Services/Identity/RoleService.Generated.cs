...
namespace TomNet.App.Core.Services.Identity
{
    ...
    /// 服务类 Role
    /// </summary> 
	public partial class RoleService : IRoleContract
    {   		
		/// <summary>
        /// 服务提供者
        /// </summary>
        ...
        /// 仓储对象
        /// </summary>
		IRepository<Role, int> _repository;
        ...
        public RoleService(IServiceProvider provider)
        {
			...
			_repository = _serviceProvider.GetService<IRepository<Role, int>>();
        ...
        /// 当前实体类型的查询数据集
        /// </summary>
        public ISugarQueryable<Role> Entities { get; }
        ...
        public Task<int> InsertAsync(Role entity)
        {
        ...
        /// </summary>
        /// <returns>操作影响的行数</returns>
        public int Insert(List<Role> entities)
        {
            return _repository.Insert(entities);
        }

        public Task<int> InsertAsync(List<Role> entities)
        {
        ...
        public Task<int> InsertAsync(Role[] entities)
        {
            return _repository.InsertAsync(entities);
        }
        ...
        public Task<Role> InsertReturnEntityAsync(Role entity)
        {
        ...
        /// <returns>操作影响的行数</returns>
        public int Update(Role entity, string[] ignoreColumns = null)
        {
            return _repository.Update(entity, ignoreColumns);
        }

        public Task<int> UpdateAsync(Role entity, string[] ignoreColumns = null)
        {
        ...
        /// <param name="ignoreColumns">不更新的列</param>
        /// <returns>操作影响的行数</returns>
        public int Update(List<Role> entitys, string[] ignoreColumns = null)
        {
            return _repository.Update(entitys, ignoreColumns);
        }

        public Task<int> UpdateAsync(List<Role> entitys, string[] ignoreColumns = null)
        {
        ...
        /// <returns>操作影响的行数</returns>
        public int Update(Expression<Func<Role, Role>> update, Expression<Func<Role, bool>> predicate = null)
        {
            return _repository.Update(update, predicate);
        }

        public Task<int> UpdateAsync(Expression<Func<Role, Role>> update, Expression<Func<Role, bool>> predicate = null)
        {
        ...
        /// <returns>操作影响的行数</returns>
        public int Delete(Expression<Func<Role, bool>> predicate)
        {
            return _repository.Delete(predicate);
        }

        public Task<int> DeleteAsync(Expression<Func<Role, bool>> predicate)
        {
        ...
        public Role GetFirst(Expression<Func<Role, bool>> predicate)
        {
            return _repository.GetFirst(predicate);
        }

        public Task<Role> GetFirstAsync(Expression<Func<Role, bool>> predicate)
        {
