...
namespace TomNet.App.Core.Services.Identity
{
    ...
    {   		
        ...
        /// 仓储对象
        /// </summary>
		IRepository<UserLogin, int> _repository;
        ...
        public UserLoginService(IServiceProvider provider)
        {
			...
			_repository = _serviceProvider.GetService<IRepository<UserLogin, int>>();
        ...
        /// 当前实体类型的查询数据集
        /// </summary>
        public ISugarQueryable<UserLogin> Entities { get; }
        ...
        public Task<int> InsertAsync(UserLogin entity)
        {
        ...
        /// </summary>
        /// <returns>操作影响的行数</returns>
        public int Insert(List<UserLogin> entities)
        {
            return _repository.Insert(entities);
        }

        public Task<int> InsertAsync(List<UserLogin> entities)
        {
        ...
        public Task<int> InsertAsync(UserLogin[] entities)
        {
            return _repository.InsertAsync(entities);
        }
        ...
        /// </summary>
        /// <returns>操作影响的行数</returns>
        public UserLogin InsertReturnEntity(UserLogin entity)
        {
            return _repository.InsertReturnEntity(entity);
        }

        public Task<UserLogin> InsertReturnEntityAsync(UserLogin entity)
        {
        ...
        /// <returns>操作影响的行数</returns>
        public int Update(UserLogin entity, string[] ignoreColumns = null)
        {
            return _repository.Update(entity, ignoreColumns);
        }

        public Task<int> UpdateAsync(UserLogin entity, string[] ignoreColumns = null)
        {
        ...
        /// <param name="ignoreColumns">不更新的列</param>
        /// <returns>操作影响的行数</returns>
        public int Update(List<UserLogin> entitys, string[] ignoreColumns = null)
        {
            return _repository.Update(entitys, ignoreColumns);
        }

        public Task<int> UpdateAsync(List<UserLogin> entitys, string[] ignoreColumns = null)
        {
        ...
        /// <returns>操作影响的行数</returns>
        public int Update(Expression<Func<UserLogin, UserLogin>> update, Expression<Func<UserLogin, bool>> predicate = null)
        {
            return _repository.Update(update, predicate);
        }

        public Task<int> UpdateAsync(Expression<Func<UserLogin, UserLogin>> update, Expression<Func<UserLogin, bool>> predicate = null)
        {
        ...
        public Task<int> DeleteAsync(UserLogin entity)
        {
        ...
        /// <returns>操作影响的行数</returns>
        public int Delete(Expression<Func<UserLogin, bool>> predicate)
        {
            return _repository.Delete(predicate);
        }

        public Task<int> DeleteAsync(Expression<Func<UserLogin, bool>> predicate)
        {
        ...
        public UserLogin GetFirst(Expression<Func<UserLogin, bool>> predicate)
        {
            return _repository.GetFirst(predicate);
        }

        public Task<UserLogin> GetFirstAsync(Expression<Func<UserLogin, bool>> predicate)
        {
